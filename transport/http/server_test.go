...
import (
	...
	httptransport "github.com/go-god/micro/transport/http"
)

func TestServerBadDecode(t *testing.T) {
	handler := httptransport.NewServer(
		func(context.Context, interface{}) (interface{}, error) { return struct{}{}, nil },
		httptransport.DecodeRequestFunc(func(context.Context, *http.Request) (interface{}, error) {
			return struct{}{}, errors.New("dang")
		}),
		httptransport.EncodeResponseFunc(func(context.Context, http.ResponseWriter, interface{}) error {
			return nil
		}),
	)
...
func TestServerBadEndpoint(t *testing.T) {
	handler := httptransport.NewServer(
		...
		httptransport.EncodeResponseFunc(func(context.Context, http.ResponseWriter, interface{}) error { return nil }),
	)
	server := httptest.NewServer(handler)
	defer server.Close()
	resp, _ := http.Get(server.URL)
...
func TestMultipleServerBefore(t *testing.T) {
	...
	handler := httptransport.NewServer(
		...
		httptransport.EncodeResponseFunc(func(_ context.Context, w http.ResponseWriter, _ interface{}) error {
...
func TestEncodeJSONResponse(t *testing.T) {
	handler := httptransport.NewServer(
		...
		httptransport.EncodeResponseFunc(httptransport.EncodeJSONResponse),
	)
...
func TestNoOpRequestDecoder(t *testing.T) {
	...
	handler := httptransport.NewServer(
		...
		httptransport.DecodeRequestFunc(httptransport.NopRequestDecoder),
		httptransport.EncodeResponseFunc(httptransport.EncodeJSONResponse),
	)
