...
func ExamplePopulateRequestContext() {
	handler := NewServer(
		...
		DecodeRequestFunc(func(context.Context, *http.Request) (interface{}, error) { return struct{}{}, nil }),
		EncodeResponseFunc(func(context.Context, http.ResponseWriter, interface{}) error { return nil }),
