...
// EncodeRequest
func (testEncodeDecode) EncodeRequest(context.Context, *http.Request, interface{}) error { return nil }

// DecodeResponse
func (testEncodeDecode) DecodeResponse(_ context.Context, r *http.Response) (interface{}, error) {
...
func TestHTTPClient(t *testing.T) {
	var (
		testEncodeDecodeStream = testEncodeDecode{}
...
func TestEncodeJSONRequest(t *testing.T) {
	...
	client := httptransport.NewClient(
		"POST",
		serverURL,
		httptransport.EncodeRequestFunc(httptransport.EncodeJSONRequest),
		httptransport.DecodeResponseFunc(func(context.Context, *http.Response) (interface{}, error) {
			return nil, nil
		}),
	).Endpoint()
...
func TestSetClient(t *testing.T) {
	...
	client := httptransport.NewClient(
		"GET",
		&url.URL{},
		httptransport.EncodeRequestFunc(encode),
		httptransport.DecodeResponseFunc(decode),
...
func TestNewExplicitClient(t *testing.T) {
	...
	client := httptransport.NewExplicitClient(
		httptransport.CreateRequestFunc(req),
