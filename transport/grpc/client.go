...
func NewClient(
	...
	c := &Client{
		...
		encRequestStream:  encRequestStream,
		decResponseStream: decResponseStream,
...
func (c Client) Endpoint() endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (response interface{}, err error) {
		...
		req, err := c.encRequestStream.EncodeRequest(ctx, request)
		if err != nil {
			return nil, err
		}
		...
		response, err = c.decResponseStream.DecodeResponse(ctx, grpcReply)
		if err != nil {
			return nil, err
		}
